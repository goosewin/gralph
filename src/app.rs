...
use crate::cli::{
    self, Cli, Command, ConfigArgs, ConfigCommand, InitArgs, LogsArgs, PrdArgs, PrdCheckArgs,
    PrdCommand, PrdCreateArgs, ResumeArgs, RunLoopArgs, ServerArgs, StartArgs, StopArgs,
    VerifierArgs, WorktreeCommand, WorktreeCreateArgs, WorktreeFinishArgs, ASCII_BANNER,
};
...
pub fn run(cli: Cli, _deps: &Deps) -> Result<(), CliError> {
