...
public sealed class OpenCodeBackend : IBackend
{
    private static readonly IReadOnlyList<string> OpenCodeModels = new[]
    {
    ...
    public IReadOnlyList<string> Models => OpenCodeModels;

    public string? DefaultModel => "opencode/example-code-model";

    public bool IsInstalled()
    {
        return ExecutableLocator.CommandExists("opencode");
    }

    public string GetInstallHint()
    {
        return "See https://opencode.ai/docs/cli/ for installation instructions";
    }
